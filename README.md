...
```bash
docker run --rm -v "$(pwd)/author.p12" -v "$(pwd)/distributor.p12" ghcr.io/georift/install-jellyfin-tizen 192.168.0.10 Jellyfin "" 'CertPassw0rd!' # Third argument empty to use latest tag
```
